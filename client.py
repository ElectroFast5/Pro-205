    ...
    for row in range(0, 3):
        ...
        for col in range(0, 9):
            if(platform.system()=='Darwin'):
                ...
                # For windows users
                boxButton=tk.Button(gameWindow, font=("Chalkboard SE",30), width=3, height=2,borderwidth=5, bg="blue")
                boxButton.place(x=xPos, y=yPos)
...
def gameWindow():
    ...
    canvas2.create_text( screen_width/4.5,50, text="Tambola Family Fun!!", font=("Chalkboard SE",50), fill="lime")
    createTicket()
    placeNumbers()
    flashNumberLabel=canvas2.create_text(400,screen_height/2.3, text="Waiting for other players to join...", font=("Chalkboard SE",30), fill="lime")
...
def askPlayerName():
    ...
    button=tk.Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=11, command=saveName, height=2, bg="pink", bd=3)
